...
inline uint64 Riscv::r_a5() {
    uint64 volatile a4;
    __asm__ volatile ("ld %0, 15*8(fp)" : "=r"(a4));
    return a4;
}

inline uint64 Riscv::r_a6() {
    uint64 volatile a4;
    __asm__ volatile ("ld %0, 16*8(fp)" : "=r"(a4));
    return a4;
}

inline uint64 Riscv::r_a7() {
    uint64 volatile a4;
    __asm__ volatile ("ld %0, 17*8(fp)" : "=r"(a4));
    return a4;
}

inline uint64 Riscv::r_a8() {
    uint64 volatile a4;
    __asm__ volatile ("ld %0, 18*8(fp)" : "=r"(a4));
    return a4;
}
